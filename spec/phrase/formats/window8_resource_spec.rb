...
describe Phrase::Formats::Windows8Resource do
  ...
  let(:the_extension) { ".resw" }

  describe "#self.directory_for_locale" do
    it "should return the path to the current dir" do
      Phrase::Formats::Windows8Resource.directory_for_locale(the_locale).should eql(the_current_directory)
    end
  end

  describe "#self.filename_for_locale" do
    subject { Phrase::Formats::Windows8Resource.filename_for_locale(the_locale) }
  ...
  describe "#self.locale_aware?" do
    subject { Phrase::Formats::Windows8Resource.locale_aware? }
