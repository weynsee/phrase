...
describe Phrase::Tool::Formats::Plist do
  ...
  describe "#self.directory_for_locale" do
    it "should return the path to the current dir" do
      Phrase::Tool::Formats::Plist.directory_for_locale(the_locale).should eql(the_current_directory)
    end
  end
  
  describe "#self.filename_for_locale" do
    subject { Phrase::Tool::Formats::Plist.filename_for_locale(the_locale) }
  ...
  describe "#self.locale_aware?" do
    subject { Phrase::Tool::Formats::Plist.locale_aware? }
