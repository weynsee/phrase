...
describe Phrase::Tool::Formats::Json do
  ...
  describe "#self.directory_for_locale" do
    it "should return the path to the current dir" do
      Phrase::Tool::Formats::Json.directory_for_locale(the_locale).should eql(the_current_directory)
    end
  end
  
  describe "#self.filename_for_locale" do
    subject { Phrase::Tool::Formats::Json.filename_for_locale(the_locale) }
  ...
  describe "#self.locale_aware?" do
    subject { Phrase::Tool::Formats::Json.locale_aware? }
