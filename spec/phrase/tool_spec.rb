  ...
  describe "commands" do
        ...
        context "file exists" do
          ...
          context "tag(s) given" do
            it "should use the tag in the upload call" do
              api_client.should_receive(:upload).with(kind_of(String), kind_of(String), ["foobar"], nil, nil, false, false, false)
    ...
    describe "pull command" do
      ...
      before(:each) do
        ...
        api_client.stub(:download_translations_for_locale).with("pl", kind_of(String), nil, nil, nil, nil).and_return("content for pl")
        api_client.stub(:download_translations_for_locale).with("ru", kind_of(String), nil, nil, nil, nil).and_return("content for ru")
        api_client.stub(:download_translations_for_locale).with("de", kind_of(String), nil, nil, nil, nil).and_return("content for de")
        api_client.stub(:download_translations_for_locale).with("cn", kind_of(String), nil, nil, nil, nil).and_raise("Error")
      end
